...
PORTRAIT_STYLE = ("Head-and-shoulders character portrait, {look}, painterly illustration, "
                  "dramatic soft lighting, dark muted background, looking slightly off-camera, "
                  "no text. {prompt}")
